                ...
                <div className="relative z-10 flex justify-center">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center gap-2 mt-1.5">
                            ...
                            <p className="text-blue-200 text-xs font-medium">Fill in the basics to get your campaign rolling.</p>
                            <span className="text-blue-300 text-sm select-none">—</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full max-w-2xl mx-auto px-4 pt-5 space-y-4">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="text-center px-6 pt-6 pb-4">
                        ...
                        <p className="text-xs text-gray-500 mt-1">Choose the campaign type that best fits your fundraising goal.</p>
                    </div>
