...
export default function RichTextEditor({ value, onChange, placeholder, className }: Props) {
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: "min-h-[140px] px-4 py-3 text-sm text-gray-800 focus:outline-none",
            },
        },
        onUpdate({ editor }) {
    ...
    return (
        <div className={`border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-orange-400 focus-within:border-orange-400 ${className ?? ""}`}>
            {/* Toolbar */}
