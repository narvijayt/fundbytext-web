            ...
            {open && (
                ...
                >
                    <div
                        ...
                        className={`w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl transition-all duration-200 ${shown ? "translate-y-0 opacity-100" : "translate-y-2 opacity-0"}`}
                    >
                        <div className="flex items-center justify-between gap-3 bg-[#0268c0] px-6 py-4 text-white">
                            <div>
                        ...
                        <div className="p-6">
                            ...
                            <div className="mt-4 overflow-hidden rounded-xl border border-[#eef1f4] bg-[#f7f9fb]">
                                {currentUrl ? (
                                    ...
                                    <div className="flex aspect-video w-full flex-col items-center justify-center gap-1 text-center">
                                        ...
                                        <p className="text-xs text-[#9aa7b8]">No default set — the built-in sample clip is used.</p>
                                    </div>
                                )}
                            </div>
                            ...
                            {/* Default video thumbnail (poster) */}
                            <div className="mt-4 border-t border-[#eef1f4] pt-4">
                                <p className="text-sm font-bold text-[#003060]">Default thumbnail</p>
                                <p className="text-[11px] text-[#9aa7b8]">Poster shown before the default video plays.</p>
                                ...
                                <div className="mt-2 overflow-hidden rounded-xl border border-[#eef1f4] bg-[#f7f9fb]">
                                    {currentThumbnailUrl ? (
                                        ...
                                        <div className="flex aspect-video w-full flex-col items-center justify-center gap-1 text-center">
                                            ...
                                            <p className="text-[11px] text-[#9aa7b8]">No thumbnail — each campaign’s hero image is used.</p>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="mt-2 flex items-center justify-between gap-2">
                                    ...
                                    <button onClick={() => thumbRef.current?.click()} disabled={busy} className="flex items-center gap-2 rounded-lg bg-[#0268c0] px-3 py-1.5 text-xs font-semibold text-white transition-[filter] hover:brightness-110 disabled:opacity-50">
                                        ...
                                        ) : (currentThumbnailUrl ? "Replace thumbnail" : "Upload thumbnail")}
                                    </button>
                                </div>
